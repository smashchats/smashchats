...
export const dev_nab_join_action: SmashActionJson = {
    ...
    did: {
        ...
        signature:
            "ZvTG9wRzaPydtuLi/GSl/kHmVQA5RC/EDeMEkMngRVWVmpqeE7PSI32ANNjxLUALHRhOiHI1rcymAnTvPqULsg==",
        endpoints: [
            {
                ...
                signature:
                    "L56lvk91VxmS6LXXfwQZqqMUdmReiLIrBJgCetRnsVBxtql7zguDYACHUUcccdQmPOG9YBice9gbvaQB+oeRZA==",
            },
        ],
    },
    config: {
...
export const sme: SMEConfigJSONWithoutDefaults = {
    url: "wss://sme.dev.smashchats.com/",
    smePublicKey:
